...
/* To start using include the following lines in the code:

  xdev_out(uart_putc); //Set the default IO device functions.
  xdev_in(uart_getc);
  
  uart_open (USART1,115200,0); //Initialize the device.
*/
